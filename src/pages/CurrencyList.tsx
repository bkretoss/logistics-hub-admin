...
// Defined OUTSIDE component to prevent remount on every render (fixes cursor-jump bug)
const Field = ({
  label, name, placeholder, form, formErrors, onChange,
}: {
  label: string;
  name: keyof FormType;
  placeholder?: string;
    ...
    <div className="space-y-6">
      ...
      <Dialog open={viewItem !== null} onOpenChange={open => { if (!open) setViewItem(null); }}>
        <DialogContent className="max-w-md">
          <DialogHeader><DialogTitle>Currency Details</DialogTitle></DialogHeader>
          {viewItem && (
      ...
      <Dialog open={modalOpen} onOpenChange={open => { if (!open) setModalOpen(false); }}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 mt-2">
            <Field label="Currency Name"   name="name"   placeholder="e.g. US Dollar" form={form} formErrors={formErrors} onChange={handleFieldChange} />
            <Field label="Currency Code"   name="code"   placeholder="e.g. USD"       form={form} formErrors={formErrors} onChange={handleFieldChange} />
            <Field label="Currency Symbol" name="symbol" placeholder="e.g. $"         form={form} formErrors={formErrors} onChange={handleFieldChange} />
            <div>
