    ...
    <div className="space-y-6">
      ...
      <Dialog open={viewItem !== null} onOpenChange={open => { if (!open) setViewItem(null); }}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Transport Mode Details</DialogTitle>
          </DialogHeader>
          {viewItem && (
            <div className="space-y-4 mt-2 text-sm">
              {[
                { label: 'ID',                  value: String(viewItem.id) },
                { label: 'Transport Mode Name', value: viewItem.name },
      ...
      <Dialog open={modalOpen} onOpenChange={open => { if (!open) setModalOpen(false); }}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>{editing ? 'Edit Transport Mode' : 'Add Transport Mode'}</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 mt-2">
            <div>
              <label className="block text-sm font-medium text-foreground mb-1">
                Transport Mode Name <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                value={form.name}
      ...
      <Dialog open={deleteId !== null} onOpenChange={open => { if (!open) setDeleteId(null); }}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            <DialogTitle>Delete Transport Mode</DialogTitle>
          </DialogHeader>
